...
Retorne APENAS o objeto JSON adaptado para o prato específico da imagem enviada.`
      ...
      // Apply enhancement using Sharp based on the analysis
      console.log('🎨 Applying AI-guided enhancement with Sharp...');
      
      const brightness = analysis.brightness || 1.2;
      const contrast = analysis.contrast || 1.3;
      const saturation = analysis.saturation || 1.4;
      ...
      await sharp(imagePath)
        ...
        .linear(contrast, -(contrast * 10))
        .sharpen({ sigma: 1.2 })
        .jpeg({ quality: 95, progressive: true })
        .toFile(outputPath);

      console.log('✅ AI-guided enhancement completed');
      ...
      console.log('✨ GPT-4o Analysis + Sharp Enhancement completed successfully!');

      return {
        success: true,
        analysis: {
          ...analysis,
          metodo: 'GPT-4o Analysis + Sharp Enhancement'
        },
